...
export default class Ball {
  ...
  paddleCollision(player1, player2) {
    ...
    if (this.vx > 0) {
      ...
      // dhStretch...but not fixed: this.y >=   . There is an inadequate formula calculation here, because the paddle does not stop the ball on the corners of the paddle.
      if (
  ...
  // dhStretch 2: When the ball strikes a paddle, beep
  pongBeep() {
    new Audio(
  ...
  render(svg, player1, player2) {
    ...
    ////////////////////////////////////////////////////////////////////////////
    // dhStretch 4: If player reaches 80% of maxScore, color paddle green   ///
    //           5: If player reaches 80% of maxScore, make paddle smaller  //
    //           6: If player reaches 70% of maxScore, play Funeral March  //
    ////////////////////////////////////////////////////////////////////////
